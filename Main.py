...
while True:
    ...
    try:
        ...
        biggestPoints= Util.getCornerPoints(rectCon[0]) 
        ...
        if biggestPoints.size != 0 and gradePoints.size != 0:
            ...
            biggestPoints=Util.reorder(biggestPoints) 
            ...
            # DISPLAYING ANSWERS
            Util.showAnswers(imgWarpColored,myIndex,grading,ans) 
            Util.drawGrid(imgWarpColored)
            imgRawDrawings = np.zeros_like(imgWarpColored) 
            Util.showAnswers(imgRawDrawings, myIndex, grading, ans) 
    ...
    stackedImage = Util.stackImages(imageArray,0.5,lables)
